                    ...
                    <div class="food-details-btn-box">
                        ...
                        <div class="food-details-btn-box-right-btn">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="true"><span>
                                        ...
                                        <div class="featured-item">
                                            ...
                                            <div class="featured-item-img">
                                                ...
                                                <div class="featured-item-img-overlay">
                                                    <div class="featured-item-img-over-text">
                                                        <div class="left-text">
                                                            <a href="{{ route('menu.food-details', $product->id) }}" class="icon">
                                                    <span>
                                            ...
                                            <div class="featured-item-text">
                                                ...
                                                <div class="text-item-center">
                                                    <h3><a href="{{ route('menu.food-details', $product->id) }}">{{ $product->name }}</a></h3> <!-- Динамическое название продукта -->
                                                </div>
