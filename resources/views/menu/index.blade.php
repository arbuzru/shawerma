                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="featured-item">
                                            <div class="featured-item-img-populer">
                                                <img src="{{ $product->image_url }}" alt="img"> <!-- Динамическое изображение -->
                                            </div>
                                            <div class="featured-item-img">
                                                <img src="{{ $product->thumbnail_url }}" class="w-100" alt="featured-thumb"> <!-- Динамическое миниатюрное изображение -->

                                                <div class="featured-item-img-overlay">
                                                    <div class="featured-item-img-over-text">
                                                        <div class="left-text">
                                                            <a href="{{ route('food-details', $product->id) }}" class="icon">
                                                    <span>
                                                        ...
                                                        <div class="right-text">
                                                            <h5>{{ $product->discount }}% Off </h5> <!-- Динамическая скидка -->
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="featured-item-text">
                                                <div class="text-item">
                                                    <div class="left">
                                                        <h3>${{ $product->price }}</h3> <!-- Динамическая цена -->
                                                    </div>
                                                    <div class="right">
                                                        <div class="icon">
                                                ...
                                                <div class="text-item-center">
                                                    <h3><a href="{{ route('food-details', $product->id) }}">{{ $product->name }}</a></h3> <!-- Динамическое название продукта -->
                                                </div>
                                                ...
                                                <span>
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="text">
                                                            <h5>{{ $product->ingredient_1 }}</h5> <!-- Динамический ингредиент -->
                                                        </div>
                                                    </div>
                                                    <div class="text-item-center-item">
                                                        <div class="icon">
                                                <span>
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="text">
                                                            <h5>{{ $product->ingredient_2 }}</h5> <!-- Динамический ингредиент -->
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 ">
                                    <div class="featured-item  ">
                                        ...
                                        <div class="featured-item-text">
                                            ...
                                            <div class="text-item-center">
                                                <h3><a href="{{ route('food-details') }}">Baked Chicken Wings and Legs</a>
                                                </h3>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 res-popular-item-mt-30px res-popular-item-mt-0px ">
                                    <div class="featured-item">
                                        ...
                                        <div class="featured-item-text">
                                            ...
                                            <div class="text-item-center">
                                                <h3><a href="{{ route('food-details') }}">BBQ Pulled Pork Sandwich</a></h3>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 res-popular-item-mt-30px">
                                    <div class="featured-item">
                                        ...
                                        <div class="featured-item-text">
                                            ...
                                            <div class="text-item-center">
                                                <h3><a href="{{ route('food-details') }}">Pork Chop with Apple Chutney</a>
                                                </h3>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 featured-item-mt" data-aos="fade-up">
                                    <div class="featured-item">
                                        ...
                                        <div class="featured-item-text">
                                            ...
                                            <div class="text-item-center">
                                                <h3><a href="{{ route('food-details') }}">Eggplant Parmesan & Linguine</a>
                                                </h3>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 featured-item-mt" data-aos="fade-up">
                                    <div class="featured-item">
                                        ...
                                        <div class="featured-item-text">
                                            ...
                                            <div class="text-item-center">
                                                <h3><a href="{{ route('food-details') }}">Fish Tacos with Chipotle Crema</a>
                                                </h3>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 featured-item-mt" data-aos="fade-up">
                                    <div class="featured-item">
                                        ...
                                        <div class="featured-item-text">
                                            ...
                                            <div class="text-item-center">
                                                <h3><a href="{{ route('food-details') }}">Quinoa-Stuffed Bell Pepper</a></h3>
                                            </div>
